...
var _slime_w = 330;
var _left_x = 24;
var _center_x = round((_gui_w - _life_w) * 0.5);
var _right_x = round(_gui_w - 24 - _slime_w);
...
draw_set_alpha(0.82);
draw_rectangle(0, 0, _gui_w, _hud_h, false);
draw_set_color(_neon_blue);
draw_set_alpha(0.55);
draw_rectangle(0, _hud_h - 2, _gui_w, _hud_h, false);
